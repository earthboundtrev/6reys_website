      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="md:hidden">
          ...
          <div className="text-gray-300 space-y-6 mb-8">
            <p>There has been a lot of continued interest in our party space rental, so here is a rundown of what we have to offer here at 6R's!</p>
          ...
          <div className="mb-12">
            <img src="https://imgur.com/Ngy3R8W.png" alt="Event Chicken" className="max-w-full mx-auto" />
          </div>
        </div>
        ...
        <div className="hidden md:block">
          ...
          <div className="flex flex-row items-start gap-8 mb-16">
            <div className="w-1/2 text-gray-300 space-y-6">
              <p>There has been a lot of continued interest in our party space rental, so here is a rundown of what we have to offer here at 6R's!</p>
